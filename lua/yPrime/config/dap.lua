...
vim.keymap.set("n", "<space>dlp", function()
...
vim.keymap.set("n", "<space>duo", function()
	dapui.open()
end)
vim.keymap.set("n", "<space>duc", function()
	dapui.close()
end)
vim.keymap.set("n", "<space>dut", function()
	dapui.toggle()
end)
vim.keymap.set("n", "<space>duu", function()
	dapui.float_element()
end)
vim.keymap.set({ "v", "n" }, "<space>de", function()
	dapui.eval()
end)
