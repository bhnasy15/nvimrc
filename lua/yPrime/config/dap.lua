...
vim.keymap.set({'n', 'v'}, '<space>dK' , function() dap_widget.hover() end)
vim.keymap.set({'n', 'v'}, '<space>dp' , function() dap_widget.preview() end)
vim.keymap.set('n'       , '<space>df' , function() dap_widget.centered_float(widgets.frames) end)
vim.keymap.set('n'       , '<space>ds' , function() dap_widget.centered_float(widgets.scopes) end)
